...
export const DEMO_DATASETS = {
  '01': {
    id: '01',
    badge: 'PREBUILT 01',
    name: 'Dumbarton Castle Survey & 3D Reconstruction',
    location: 'Dumbarton Fortress & Agricultural Ramparts',
    modelUrl: formatUrl('datasets/02_slam_model.glb'),
    videoUrl: formatUrl('datasets/01_odm_survey.mp4'),
    framesDir: 'datasets/frames_01',
    depthDir: null,
    framePrefix: 'frame_',
    frameExt: '.jpg',
    thumbUrl: formatUrl('datasets/frames_01/frame_024.jpg'),
    maxFrames: 50,
    format: '01_dumbarton_castle.glb',
    rotationY: 0,
    rotX: -Math.PI / 2,
    scaleFactor: 1.0,
    fileSize: '9.6 MB',
    videoSize: '11.6 MB',
    videoRes: '1080p 60 FPS',
    vertices: '192,096',
    triangles: '384,192',
    gsd: '1.42 cm/px',
    reprojectionError: '0.42 px',
    datum: 'EPSG:32630 UTM 30N',
    horizontalRmse: '0.024 m',
    verticalRmse: '0.038 m',
    reconstructedArea: '42,500 m²',
    sensor: 'Sony 20MP 1" CMOS (24mm focal)',
    description: 'Autonomous UAV survey flight and watertight 3D textured mesh reconstruction of Dumbarton Castle ramparts, river wall, and lawn terrain.'
  },
  '02': {
    id: '02',
    badge: 'PREBUILT 02',
    name: 'Architectural Masonry Survey & Aerial Orbit',
    location: 'Historic Masonry Quad & Building Facades',
    modelUrl: formatUrl('datasets/03_building_model.glb'),
    videoUrl: formatUrl('datasets/03_building_orbit.mp4'),
    framesDir: 'datasets/frames_02',
    depthDir: null,
    framePrefix: 'frame_',
    frameExt: '.jpg',
    thumbUrl: formatUrl('datasets/frames_02/frame_024.jpg'),
    maxFrames: 50,
    format: '02_building_facade.glb',
    rotationY: 0,
    rotX: -Math.PI / 2,
    scaleFactor: 1.0,
    fileSize: '7.5 MB',
    videoSize: '21.1 MB',
    videoRes: '1080p 30 FPS',
    vertices: '262,144',
    triangles: '524,288',
    gsd: '1.82 cm/px',
    reprojectionError: '0.48 px',
    datum: 'EPSG:32630 UTM 30N',
    horizontalRmse: '0.028 m',
    verticalRmse: '0.041 m',
    reconstructedArea: '28,900 m²',
    sensor: 'AeroSculpt Aerial Inspection Sensor',
    description: 'High-density multi-angle orbital facade survey reconstructing intricate architectural masonry and structural geometry.'
  },
  '03': {
    id: '03',
    badge: 'PREBUILT 03',
    name: 'EPFL Fountain 360° Benchmark',
    location: 'EPFL Fountain Multi-View Photogrammetry Benchmark',
    modelUrl: formatUrl('datasets/03_fountain_mesh.ply'),
    videoUrl: formatUrl('datasets/03_fountain_survey.mp4'),
    framesDir: 'datasets/frames_03',
    depthDir: 'datasets/depth_03',
    framePrefix: 'frame_',
    frameExt: '.jpg',
    thumbUrl: formatUrl('datasets/frames_03/frame_015.jpg'),
    maxFrames: 33,
    format: '03_fountain_mesh.ply',
    rotationY: 0,
    rotX: 0,
    scaleFactor: 18.0,
    fileSize: '19.8 MB',
    videoSize: '1.7 MB',
    videoRes: '3072x2048 Benchmark',
    vertices: '536,872',
    triangles: '1,033,745',
    gsd: '0.18 cm/px',
    reprojectionError: '0.29 px',
    datum: 'EPSG:2056 Swiss LV95 (Local)',
    horizontalRmse: '0.008 m',
    verticalRmse: '0.012 m',
    reconstructedArea: '1,250 m²',
    sensor: 'Canon EOS 100D (28mm Prime)',
    description: 'Multi-view 360° orbital photogrammetry benchmark comprising 33 high-resolution calibrated stations and 16-bit dense depth consensus.'
  }
};
